    ...
    <div className="container">
      ...
      >
        <div className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
          <div className="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            ...
            >
              ...
              <p className="lead m-md-3">
                Charlie is dedicated to bringing comfort to the everyday lives
                of our customers. For concerns regarding comfort and product
                flexibility, Charlie can be personally reached at{" "}
          ...
          <div className="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div
              className="my-3 p-3 border border-warning rounded"
              style={{ color: "white" }}
            >
              <h2 className="display-5">Maurissa Higgins</h2>
              <p className="lead">
                Maurissa makes sure our customers are always dressed to impress.
                Concerns regarding product design can be directed to Maurissa at{" "}
          ...
          <div className="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            ...
            >
              ...
              <p className="lead">
                ...
                and extends special acknowledgments to the inspiration of our
                designs,{" "}
                <strong className="text-warning">
